...
const char *target_compiler_driver = STANDARD_BINDIR_PREFIX DEFAULT_TARGET_MACHINE "-g++";
const char *target_compiler_epath = STANDARD_EXEC_PREFIX DEFAULT_TARGET_MACHINE "/" DEFAULT_TARGET_VERSION "/";
const char *target_compiler_cpath = STANDARD_LIBEXEC_PREFIX DEFAULT_TARGET_MACHINE "/" DEFAULT_TARGET_VERSION "/:" LIBEXECSUBDIR "/";
const char *target_compiler_lpath = STANDARD_EXEC_PREFIX DEFAULT_TARGET_MACHINE "/lib64/";
